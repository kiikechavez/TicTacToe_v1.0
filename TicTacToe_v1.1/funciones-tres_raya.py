# -*- coding: utf-8 -*-
"""
Created on Sat Mar 12 13:50:41 2022

@author: USUARIO
"""

import random
#import identify_player
import cv2
#import funciones_robot
...
def getPlayerMove(board,movimientos=0):
...
def getComputerMove(board, computerLetter, counter=0):
    ...
    if (counter==3):
        if((board[1]!=' ' and board[9]!=' ')or(board[3]!=' ' and board[7]!=' ')):
            return chooseRandomMoveFromList(board, [2, 4, 6, 8])
        if(board[6]!=' ' and board[7]!=' '):
            return 9
        if(board[2]!=' ' and board[7]!=' '):
            return 1
